...
let debugMode = false;
const appVersion = "1.7.025092422h51m46s"; 
let debugLogEntries = [];
...
window.addEventListener('load', () => {
    if (showToastOnLoad) {
        showTopRightToast('我买了新的芙宁娜周边');//我在这输入文字
    }
});
...
if (localStorage.getItem('theme') === 'light') { //肝帝永不没落！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
        ...
        function displaySearchResults(results) {
            ...
            results.forEach((song) => {
                ...
                idDisplay.className = 'song-id';
                idDisplay.textContent = `ID: ${song.id}`;
                
                resultItem.appendChild(songInfo);
                resultItem.appendChild(idDisplay);
